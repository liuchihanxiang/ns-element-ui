tinymce.PluginManager.add('mathjax',
function(editor, url) {
    ...
    let mathjaxUrl = editor.settings.mathjax.lib || url + '/tex-mml-chtml.js';
    ...
    let openMathjaxEditor = function(target) {
        ...
        editor.windowManager.open({
            ...
            body: {
                ...
                items: [{
                    type: 'htmlpanel',
                    html: '<div style="font-size:12px"> <input onclick=changesybol() type=checkbox id=cb_br name=cb_br>换行</div>'
                },
                {
                    type: 'textarea',
                    name: 'title'
